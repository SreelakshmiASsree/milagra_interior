        ...
        <>
            ...
            >
                <div className="container max-w-3xl px-6 text-white">
                    <h1 className="lg:text-[72px] md:text-5xl text-4xl font-medium leading-tight lg:ml-44">
                        Gallery
                    </h1>
                </div>
            </div>
            ...
            <div className="container">
                ...
                <div className="w-full max-w-md sm:max-w-2xl lg:max-w-3xl my-3 md:flex justify-start items-start hidden lg:mt-10 mt-5">
                    <Link href="/">
                        <button className="mb-5 backdrop-blur-md flex items-center justify-center text-[#fff] bg-[#845607] px-3 py-2 rounded-xl font-semibold text-[18px] leading-[17px]">
                ...
                {/* Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:gap-6 lg:my-10 my-5">
